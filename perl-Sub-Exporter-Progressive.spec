...
cp %{_builddir}/Sub-Exporter-Progressive-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Sub-Exporter-Progressive/e9789d579cadf405b8268d1040af8442ef6d0f1a || :
if test -f Makefile.PL; then
